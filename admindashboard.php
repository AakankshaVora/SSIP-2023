          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                      <?php
                      $client=mysqli_query($conn, "select count(status) as total from detail where status='Approved' ");
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                      <?php
                                            $advocate=mysqli_query($conn, "select count(Full_name) as total from register where u_type='user'");
                                            $values=mysqli_fetch_assoc($advocate);
                                            $num_rows=$values["total"];
                                            echo "".$num_rows."";
                      ?>
                      </h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Pending Advocates</h5>

                  <div class="d-flex align-items-center">
                    <div style="color: #2eca6a;
    background: #e0f8e9;"  class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="bi bi-person-fill-exclamation"></i>
                    </div>
                    <div class="ps-3">
                      <h6>
                      <?php
                       $pending=mysqli_query($conn, "select count(status) as pending from register where status='pending' and u_type='user'");
                       $values=mysqli_fetch_assoc($pending);
                       $num_rows=$values["pending"];
                       echo "".$num_rows."";
                      ?>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Rejected Advocates </h5>

                  <div class="d-flex align-items-center">
                    <div style="    color: #ff771d;
    background: #ffecdf;" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="bi bi-person-fill-x"></i>
                    </div>
                    <div class="ps-3">
                      <h6>
                      <?php
                      $rejected=mysqli_query($conn, "select count(status) as rejected from register where status='Rejected' and u_type='user'");
                      $values=mysqli_fetch_assoc($rejected);
                      $num_rows=$values["rejected"];
                      echo "".$num_rows."";
                      ?>
            ...
            <!-- <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                ?>
                      <tr>
                        <th scope="row"><?php echo $row["case_number"]; ?></a></th>
                        ...
                        <td><button type="button" class="btn btn-link"><a href="dashboardcases.php?id=<?php echo $row["case_number"]; ?>"><i class="bi bi-info-circle"></i></a></button></td>
                      </tr>
                      <?php
                }
