  ...
  <main id="main" class="main">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php
                      $client=mysqli_query($conn, "select count(Full_name) as total from register where u_type='user'");
    ...
    background: #e0f8e9;" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    ...
                    <div class="ps-3">
                      <h6>
                      <?php
                      $pending=mysqli_query($conn, "select count(status) as pending from register where status='pending'");
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                      <?php
                      $rejected=mysqli_query($conn, "select count(status) as rejected from register where status='Rejected'");
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Advocate Details</h5>

                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>   
                        <th scope="col">Advocate Name</th>
                        <th scope="col">Advocate type</th>
                        <th scope="col">BarRegister Number</th>
                        <th scope="col">Advocate type</th>
                    ...
                    <?php
                    $count = 0;
                    $res = mysqli_query($conn, "select * from register where u_type='user'");
                ...
                ?>
                      <tr>
                        ...
                        <td class="text-primary"><?php echo $row["case_type"]; ?></td>
                        <td><?php echo $row["bar_number"]; ?></td>
                        ...
                        <td><button type="button" class="btn btn-link"><a href="abc.php?id=<?php echo $row['ID']; ?>"><i class="bi bi-info-circle"></i></a></td>
                      </tr>
                      <?php
