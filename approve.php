...
$data=mysqli_query($conn, "update register set status='Approved' where  ID='$id'");
...
// Subject
$subject = 'Approve Mail for adovcate registration';
...
// Additional headers
$headers[] =$email;
// $headers[] = 'From: Approved  <yashshah28072004@gmail.com>';
