...
<nav class="header-nav ms-auto">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- End Dashboard Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="loginpage.php">
...
<!-- End Sidebar-->
  ...
  <main id="main" class="main">
    ...
    <div class="container d-flex flex-column align-items-center position-relative" data-aos="zoom-out">
      <h2>Legal<span>&nbsp;Department</span></h2>
      <p>Government Of Gujarat.</p>
      <div class="d-flex">
        <a href="registrationForm.php" class="btn-get-started scrollto">Register</a>&nbsp;&nbsp;
        <a href="loginpage.php" class="btn-get-started scrollto">Login</a>
      </div>
    </div>
  </section>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Total Coarts</a></h4>
              <h5>1101</h5>
            </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Advocates</a></h4>
              <h5>21663</h5>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Bills passed</a></h4>
              <h5>53151</h5>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Amount given</a></h4>
              <h5>25Cr</h5>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <h4>
                  Begin by registering for our platform and creating your account. Once registered, log in with your credentials to access your account.
                </h4>
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="xyz/img/features-1.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Step-2</h3>
                <h4>
                  After logging in, provide comprehensive details about your case. Ensure you include all necessary information and documents to facilitate the approval process.
                </h4>
                
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="xyz/img/features-2.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Step-3</h3>
                <h4>
                  Upload the relevant bills and supporting documents for approval. Make sure all uploaded documents are clear, well-organized, and in the required format.
                </h4>
                
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="xyz/img/features-3.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Step-4</h3>
                <h4>
                 Our experienced administrators will review the submitted bills and associated details. They will carefully evaluate your case and make an informed decision to either approve or reject your bills
                </h4>
                
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="xyz/img/features-4.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-5">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Step-5</h3>
                <h4>
                 If your bills are approved, the approved amount will be credited to your designated account. You will receive a notification confirming the successful transfer. 
                </h4>
                
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="xyz/img/features-5.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-6">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Step-6</h3>
                <h4>
                 In the event that your bills are rejected, you have the option to reapply. Carefully review the feedback provided by our administrators, make necessary adjustments, and resubmit your case for reevaluation.
                </h4>
                
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="xyz/img/features-6.svg" alt="" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              Legal Department; Block- 4;<br>
                New Sachivalay,  
                Gandhinagar- 382010<br><br>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Services</h4>
            <ul>
             <li><i class="bx bx-chevron-right"></i> <a href="#">Steps</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Billing</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Approvals</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Feedback</h4>
            <p>Give feedback for any bug issues.</p>
    ...
    <div class="footer-legal text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Legal</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
