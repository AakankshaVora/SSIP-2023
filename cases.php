            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  ...
                  <?php
                  $data=mysqli_query($conn,"select * from detail where 	ID=$id");
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-9 col-md-8"><?php
                        ...
                        <button type="button" class="btn btn-primary"><a href="uploads/<?php echo $row['document'];?>"  style="color:white" target="" download>Download</a></button>
                       <?php  
