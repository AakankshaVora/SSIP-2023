...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="superadmincaseDetails.php">
          <i class="bi bi-card-list"></i>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h5 class="card-title">Define Roles </h5>
                ...
                ?>
                     <tr>
                        ...
                        <td><button type="button" class="btn btn-link"><a href="abc.php?id=<?php echo $row['ID']; ?>"><i class="bi bi-info-circle"></i></a></td>
						            <td><button type="button" class="btn btn-primary btn-sm" name="superior">
                           <a href="makeadmin.php?id=<?php echo $row['ID']; ?>" style="color:white;"> 
                            <?php if($row["u_type"] == 'user') {
                               ?>
                               <a href="makeadmin.php?id=<?php echo $row['ID']; ?>" style="color:white;">Make superior 
                               <?php

                            }
                            else{
                              ?>
                              <a style="color:white;"> superior 
                              <?php
                            }
                              ?></td>
